/*
  # Initialize Database Schema for Aquatic Play Equipment Catalog

  1. New Tables
    - `categories` - Product categories with labels and settings
    - `products` - Product catalog with full details and relationships
...
-- Function to auto-generate product numbers
